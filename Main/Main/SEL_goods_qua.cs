...
namespace Main
{
    public partial class SEL_goods_qua : UIForm
    {
        public SEL_goods_qua()
        {
            InitializeComponent();
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                uiDataGridView1.Rows[i].Cells[2].Value = SELLER_INFO.goods_volume[i];
                SELLER_INFO.goods_id[i]=0;
                SELLER_INFO.goods_volume[i]=0;
