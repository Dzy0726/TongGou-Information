...
namespace Main
{
    public partial class Form_TypeQuaResult : UIForm
    {
        public Form_TypeQuaResult()
        {
            InitializeComponent();
        }
        ...
        private void Form_TypeQuaResult_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                uiDataGridView1.Rows[i].Cells[2].Value = result[i].quantity.ToString();//销量
            }
        }
