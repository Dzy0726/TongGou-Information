...
namespace DBTest
{
    class OrderInfo
    {
        ...
        static public int[] OrderID = new int[100];    //存储订单ID
        static public string[] OrderTime = new string[100]; //存储对应时间 相同下标表示一组

        static public void QueryByOrder(int order_id,int customer_id)
        {
            int i = 0;
        ...
        static public void QueryByDate(int customer_id,int year,int month,int day)
        {
            int i = 0;
         ...
         *       如：按订单号查询：1********，-1，-1，-1    
         *           按订单日期查询：-1，2020，9，17    */
        static public string[] Departure = new string[100];
        static public string[] Destination = new string[100];
        static public double[] OrderCost = new double[100];

        static public void OrderIntro(int customer_id,int order_id,int year,int month,int day)
        {
            int i = 0;
            string DT = Date(year, month, day);
            string connString = "server=localhost;database=db_mall;uid=root;pwd=123456";
         ...
         *       如：按订单号查询：1********，-1，-1，-1    
         *           按订单日期查询：-1，2020，9，17    */
        static public string[] GoodsName = new string[100];
        static public string[] StoreName = new string[100];
        static public double[] GoodsPrice = new double[100];
        static public int[] GoodsNum = new int[100];

        static public void OrderDetail(int customer_id,int order_id,int year,int month,int day)
        {
            int i = 0;
            string DT = Date(year, month, day);
            string connString = "server=localhost;database=db_mall;uid=root;pwd=123456";
         ...
         * 查询结果：消费金额
         * 传送方式：CustomerCost[]      */
        static public double[] CustomerCost = new double[100];

        static public void CostByDate(int customer_id,int year,int month,int day)
        {
            int i = 0;
            string DT = Date(year, month, day);
            string connString = "server=localhost;database=db_mall;uid=root;pwd=123456";
        ...
        static public double[] CusCostMonth = new double[13];
        
        static public void CostByMonth(int customer_id,int year)
        {
            ...
            using (MySqlCommand cmd = new MySqlCommand())//创建查询命令
            {
                ...
                while (reader.Read())//按行执行查询，每次循环查询一行
                {
                    CustomerCost[reader.GetInt32(0)] = reader.GetDouble(1);
        ...
        static public string[] GoodsType = new string[5];
        static public double[] CostForType = new double[5];

        static public void CostByType(int customer_id,int year,int month,int day)
        {
            int i = 0;
            string DT = Date(year, -1, -1);
            string connString = "server=localhost;database=db_mall;uid=root;pwd=123456";
